            ...
            try {
                ...
                if (StringUtils.isNotEmpty(filename)) {
                    ...
                    if (file.exists()) {
                        ...
                        fileOutputStream.write(sw.toString().getBytes("utf-8"), 0, sw.toString().getBytes().length);
                ...
                //添加到zip
                if (StringUtils.isNotEmpty(filename)) {
                    zip.putNextEntry(new ZipEntry(filename.replace(config.getString("staticPath"),"")));
...
//		}
    ...
    public static String getFileName2(String template, String className, String classname, String staticPath, String packageName, String packagePath) {
        ...
        if (template.contains("domain.java.vm")) {
            return packagePath + "domain" + "/" + className + "DO.java";
        }
